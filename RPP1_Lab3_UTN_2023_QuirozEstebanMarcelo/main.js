...
let people = jsonArray.map((item) => {
  return "enemigo" in item && "robos" in item && "asesinatos" in item
    ? new Villano(
        item.id,
        item.nombre,
        item.apellido,
...
const addCheckboxs = () => {
  ...
  const selectedInputs =
    selectedValue === "persona"
      ? [...inputsDefault, ...inputsVillano, ...inputsHeroes]
      : selectedValue === "villano"
      ? [...inputsDefault, ...inputsVillano]
      : [...inputsDefault, ...inputsHeroes];
...
const createRow = (item) => {
  ...
  const selectedInputs = [...inputsDefault, ...inputsVillano, ...inputsHeroes];
...
const addInputByTypePerson = (initialValues) => {
  ...
  const selectedInputs = typeField.value === "heroe" ? inputsHeroes : inputsVillano;
...
const addPerson = (formData) => {
  ...
  const personObject =
    "enemigo" in item && "robos" in item && "asesinatos" in item
      ? new Villano(
          item.id,
          item.nombre,
          item.apellido,
